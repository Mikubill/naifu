...
# from: https://github.com/lehduong/torch-warmup-lr/blob/master/torch_warmup_lr/wrappers.py

class WarmupLR(_LRScheduler):
    def __init__(self, scheduler, init_lr=1e-3, num_warmup=1, warmup_strategy="linear", **kwargs):
